...
import com.portfolio.natalia.Dto.dtoProyectos;
import com.portfolio.natalia.Entity.Proyectos;
import com.portfolio.natalia.Security.Controller.Mensaje;
import com.portfolio.natalia.Service.SProyectos;
...
public class CProyectos {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoproyectos){
        ...
        Proyectos proyectos = new Proyectos(dtoproyectos.getNombreE(), dtoproyectos.getDescripcionE(),dtoproyectos.getImg_proyecto(),dtoproyectos.getUrl_proyecto());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyectos dtoproyectos){
        ...
        proyectos.setImg_proyecto(dtoproyectos.getImg_proyecto());
        proyectos.setUrl_proyecto(dtoproyectos.getUrl_proyecto());
